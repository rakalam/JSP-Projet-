...
<body>
       ...
       <a href="page_acceuille.jsp" class="btn btn-close mb-2" style="position: relative;top: -2em; left: 18em">
         ...
         <div style="line-height: 3px;">
	           ...
	           <span>AJOUTER </span> <span style="font-family: impact;">APPARTEMENT </span></p>
	           <p class="" style="color:rgb(227, 178, 19); font-size: 2em; font-weight: 600;margin-left: 10em"> CRUD - AJOUT </p>
        </div><br><br>
          <form action="back?choix=ajout_trano" method="post" id="aj">
		           ...
		           placeholder="Design" name="design" class="form-control p-3 mb-3" required>
		           ...
		           placeholder="Loyer " name="loyer" class="form-control p-3 mb-3" required>
		           ...
		           <b style="font-weight: 800;"> AJOUTER </b> </button> 
